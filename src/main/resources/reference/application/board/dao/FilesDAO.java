...
public class FilesDAO {
	...
	//첨부파일 추가(SQL)
	private void insert(com.liveTogether.app.board.vo.BoardFile file) {
		sqlSession.insert("Files.insert", file);
	}
	
	//첨부파일 추가(로직)
	public void insert(MultipartRequest multi, int boardNumber) {
		com.liveTogether.app.board.vo.BoardFile file = new com.liveTogether.app.board.vo.BoardFile();
	...
	//첨부파일 가져오기
	public List<com.liveTogether.app.board.vo.BoardFile> select(int boardNumber){
