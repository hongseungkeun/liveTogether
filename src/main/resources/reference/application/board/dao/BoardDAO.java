package com.develop.liveTogether.application.board.dao;
...
import com.develop.liveTogether.application.board.dto.BoardDTO;
...
public class BoardDAO {
	...
	//게시글 목록
	public List<com.liveTogether.app.board.vo.Board> selectAll(Map<String, Integer> boardMap) {
	...
	//게시물 작성
	public void insert(com.liveTogether.app.board.vo.Board board) {
	...
	//정보조회
	public com.liveTogether.app.board.vo.Board selectDetail(int boardNumber) {
	...
	//게시글 수정
	public void update(com.liveTogether.app.board.vo.Board board) {
		sqlSession.update("Board.update",board );
	}
	
	//게시글 검색
	public List<com.liveTogether.app.board.vo.Board> search(BoardDTO board) {
