...
public class InquiryAdminOk implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		req.setAttribute("inquiryList", dao.inquiryAdminList(inquiryMap));
		...
		af.setPath("/admin/adminInquiry.jsp");
		return af;
	}
