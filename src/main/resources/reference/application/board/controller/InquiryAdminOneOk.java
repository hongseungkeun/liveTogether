...
public class InquiryAdminOneOk implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		int total = dao.getInquiryCountOne();
		...
		req.setAttribute("inquiryList", dao.inquiryAdminListOne(inquiryMap));
		...
		af.setPath("/admin/adminInquiryOne.jsp");
		return af;
	}
