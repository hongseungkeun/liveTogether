...
public class InquiryAdminZeroOk implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		int total = dao.getInquiryCountZero();
		...
		// 아래의 삼항 연산자를 깔끔하게 하기 위하여 temp 변수에 리퀘스트 값을 받아준다.
				...
				req.setAttribute("inquiryList", dao.inquiryAdminListZero(inquiryMap));
				...
				af.setPath("/admin/adminInquiryZero.jsp");
		return af;
	}
