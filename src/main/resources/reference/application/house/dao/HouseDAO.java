...
import com.develop.liveTogether.application.house.dto.HouseDTO;
import com.develop.liveTogether.application.house.dto.HouseFilterDTO;
import com.develop.liveTogether.application.house.dto.HouseMemberDTO;
...
//	방 추가하기
	public void registroom(com.liveTogether.app.house.vo.HouseRoom house) {
...
//	 방에 몇명이 살고있는지
	...
	public List<com.liveTogether.app.house.vo.HouseRoom> selectRealAll(Map<String, Integer> houseMap) {
	...
	// 방 정보 조회
	public List<com.liveTogether.app.house.vo.HouseRoom> roomInfo(int houseNumber) {
	...
	// 방 정보 수정
	public void updateRoomInfo(com.liveTogether.app.house.vo.HouseRoom room) {
	...
	// admin페이지에 필요한 방 전체 리스트
	public List<com.liveTogether.app.house.vo.HouseRoom> adminSelectAll(Map<String, Integer> houseMap) {
