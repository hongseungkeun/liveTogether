...
public class HouseFileDAO {
	...
	// 첨부파일 추가(SQL)
	private void insertHF(com.liveTogether.app.house.vo.HouseFile file) {
		sqlSession.insert("houseFiles.insertHF", file);
	}

	// 첨부파일 추가(로직)
	public void insertHF(MultipartRequest multi, int houseNumber) {
		com.liveTogether.app.house.vo.HouseFile file = new com.liveTogether.app.house.vo.HouseFile();
	...
	//방 사진만
		public List<com.liveTogether.app.house.vo.HouseFile> getRoomImg(Map<String, Integer> house){
	...
	//하우스 전체 사진 가져오기
	public List<com.liveTogether.app.house.vo.HouseFile> getHouseImg(int houseNumber){
