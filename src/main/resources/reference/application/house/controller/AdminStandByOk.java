...
public class AdminStandByOk implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		// 게시글의 전체 갯수
				...
				//boardMap 에다가 key값과 value값을 넣어준다.
				houseMap.put("startRow", startRow);
				houseMap.put("rowCount", rowCount);
		
				req.setAttribute("houseList", dao.adminSelectAll(houseMap));
				...
				af.setPath("/admin/adminStandBy.jsp");
